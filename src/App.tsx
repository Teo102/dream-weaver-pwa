  ...
  return (
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        <Toaster />
        <Sonner />
        {/* IMPORTANT : BrowserRouter doit être défini une seule fois (dans main.tsx) */}
        <Routes>
          ...
          <Route
            path="/settings"
            element={<Layout><div className="p-6 text-center text-muted-foreground">Réglages à venir</div></Layout>}
          />
